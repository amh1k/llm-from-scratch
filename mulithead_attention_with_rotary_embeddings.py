...
from rotaryEmbeddings import RotaryEmbeddings, apply_rotary_emb
class MultiHeadAttention(nn.Module):
    def __init__(self, d_in, d_out, context_length,dropout, num_heads, hasBias=False):
        ...
        self.rope=RotaryEmbeddings(self.head_dim, max_seq_len=context_length)
    ...
    def forward(self, X):
        ...
        cos,sin= self.rope(queries, no_tokens)
